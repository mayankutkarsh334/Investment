...
```mermaid
xychart-beta
    title "CAGR by Lookback — Rises With Horizon (Mirror of DSP/Bandhan)"
    x-axis ["1Y", "3Y", "5Y", "7Y", "10Y", "Since Inception"]
    y-axis "Return %" 0 --> 22
    bar [1.84, 17.08, 18.93, 20.58, 19.57, 20.18]
```
...
```mermaid
xychart-beta
    title "5Y CAGR — All 8 Shortlisted Small Cap Funds"
    x-axis ["Bandhan", "Invesco", "BOI", "HSBC", "Edelweiss", "Union", "Sundaram", "DSP"]
    y-axis "5Y CAGR %" 16 --> 25
    bar [23.52, 22.11, 20.88, 18.93, 19.80, 19.56, 19.46, 19.18]
...
```mermaid
xychart-beta
    title "Calendar Year Returns — HSBC Small Cap (formerly L&T EBF)"
    x-axis ["2014*", "2015", "2016", "2017", "2018", "2019", "2020", "2021", "2022", "2023", "2024", "2025", "2026 YTD"]
    y-axis "Return %" -30 --> 85
    bar [39.20, 13.02, 11.06, 67.77, -12.94, -7.07, 16.76, 79.30, 2.09, 47.56, 29.82, -10.63, 6.06]
...
```mermaid
xychart-beta
    title "Era CAGR — L&T (2014-2022) vs HSBC (2022-2026)"
    x-axis ["L&T era (8.5Y)", "HSBC era (3.5Y)"]
    y-axis "CAGR %" 0 --> 25
    bar [21.00, 17.92]
```
...
```mermaid
xychart-beta
    title "2018 IL&FS Crash & 2019 — HSBC vs DSP vs Benchmark"
    x-axis ["2018 (IL&FS)", "2019"]
...
```mermaid
timeline
    title HSBC/L&T Small Cap — The 2018-2020 "Small-Cap Winter" Drawdown
    Jan 2018 : Peak NAV Rs 30.67 (8-Jan-2018) : Pre-IL&FS small-cap top
    2018 : IL&FS crisis : Calendar -12.94% (better than -26.80% benchmark)
    2019 : Small-cap bear grinds on : Calendar -7.07% ; still below Jan-2018 peak
    Mar 2020 : COVID trough Rs 14.58 (24-Mar-2020) : Total drawdown -52.45% from Jan-2018 peak
    Feb 2021 : Recovery to peak (16-Feb-2021) : ~3 years underwater ; 329 days from trough
```
...
```mermaid
xychart-beta
    title "Rolling 3Y Return Distribution — HSBC Small Cap"
    x-axis ["< 0%", "0-12%", "12-15%", "15-20%", "20-30%", "> 30%"]
    y-axis "% of Windows" 0 --> 45
    bar [9.9, 11.0, 2.9, 18.1, 38.0, 20.1]
```
...
```mermaid
xychart-beta
    title "Rolling 5Y Return Distribution — HSBC Small Cap"
    x-axis ["< 0%", "0-12%", "12-15%", "15-20%", "20-30%", "> 30%"]
    y-axis "% of Windows" 0 --> 50
    bar [0.0, 18.0, 17.9, 18.2, 41.0, 4.9]
```
...
```mermaid
xychart-beta
    title "Probability of Loss by Holding Period"
    x-axis ["1Y", "3Y", "5Y"]
    y-axis "% Negative Windows" 0 --> 35
    bar [30.0, 9.9, 0.0]
```
...
```mermaid
xychart-beta
    title "SIP XIRR vs Lumpsum CAGR by Period"
    x-axis ["1Y", "3Y", "5Y", "7Y", "10Y"]
    y-axis "Return %" 0 --> 25
    bar [1.84, 17.08, 18.93, 20.58, 19.57]
    line [3.50, 8.71, 15.13, 21.79, 19.00]
```
...
```mermaid
xychart-beta
    title "Up-Capture vs Down-Capture (annual, vs Nifty SC 250 TRI)"
    x-axis ["Up-Capture", "Down-Capture"]
    y-axis "Capture %" 0 --> 130
    bar [115.6, 63.8]
```
...
xychart-beta
    ...
    x-axis ["2025 (full year)", "2026 YTD", "1Y trailing"]
    y-axis "Return %" -12 --> 8
    bar [-10.63, 6.06, 1.84]
```
...
```mermaid
xychart-beta
    title "Sharpe Ratio (screening basis) — All 8 Shortlisted Funds"
