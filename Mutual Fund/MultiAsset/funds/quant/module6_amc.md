...
```mermaid
xychart-beta
    title "AMC Regulatory / Governance Cleanliness — Studied AMCs (5 = cleanest)"
    x-axis ["PPFAS", "DSP", "SBI", "Nippon", "Franklin", "Quant"]
    y-axis "Cleanliness (1-5)" 0 --> 5
    bar [5.0, 4.5, 3.5, 3.5, 2.5, 1.5]
```
...
```mermaid
xychart-beta
    title "quant Money Managers — Module 6 Sub-Dimension Scores (1–5)"
    x-axis ["Governance/reg", "Ownership/oversight", "Heritage/depth", "Debt desk", "Commodity desk", "Financial stability", "Investor-first", "Succession"]
    y-axis "Score" 0 --> 5
    bar [1.5, 2.0, 2.0, 2.5, 2.5, 3.0, 1.0, 1.5]
```
