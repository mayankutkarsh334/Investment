...
| **7** | **Sundaram Mid Cap** | **≈3.35 / 5** | ✅ **Complete** (6 modules + README) — **"good book, good house, bad price"**; the confirm-elimination — safest live risk profile + deepest record + cleanest AMC of the group, but the study's most expensive fee (1.06%, fails own screen) confiscates its real +1.66%/yr gross alpha |

> **✅ ALL 7 FUNDS STUDIED — the shortlist is complete.** Final standings: **Edelweiss 4.05 > Invesco 3.97 ≈ Nippon 3.96 > Mahindra 3.83 > ICICI 3.55 > HSBC 3.49 > Sundaram 3.35.** The top trio separates cleanly from the back four; all seven are R² ~90–95% correlated (single-occupancy slot). Next: `decision_tree.md`.
...
> **The standings (6 of 7 studied):** Edelweiss ≈4.05 leads on **balance** — the only fund with no high-weight module below 4.0 *and* the best manager module (3.7). Behind it, Invesco (≈3.97) and Nippon (≈3.96) remain a **statistical dead heat for #2** with opposite shapes — Invesco wins the fund-level modules, Nippon the institution-level ones. **Mahindra Manulife (≈3.83) lands #4** — structure-strong (best capacity runway, subsidized ER, 66.6% AS) but warranty-weak (departed author, 7-month team, loss-making AMC). **ICICI Pru (≈3.55) lands #5** with a fourth distinct shape — **manager-and-book-strong, economics-weak**: a decisively active 73.9% cyclical book run by a verified cross-fund cycle-timer (Lalit Kumar's Business Cycle Fund, positive every year since 2021), but failing the canonical index test (−0.35%/yr) at the study's highest true cost (~1.08%), so its recent turnaround reads as a regime-contingent capex bet you pay top price to own. **HSBC (≈3.49) is #6, Sundaram (≈3.35) is #7.** All seven are R² ~90–95% correlated: **the midcap slot is single-occupancy** — the decision tree weighs Edelweiss's capacity trajectory vs Invesco's key-person trigger vs Nippon's capacity clock vs MM's manager warranty vs ICICI's cost-and-regime dependence. **Sundaram (≈3.35) closes the shortlist as the confirm-elimination** — a genuinely good book (real +1.66%/yr gross selection alpha, the safest low-vol profile of the seven, the deepest cycle-tested record, the cleanest AMC) with no path to selection, because the study's most expensive fee (1.06%, official — it fails the study's own ER screen) plus a 0.63% cash drag leave +0.17%/yr net; for the risk-averse investor its low volatility attracts, the 0.20% index fund does nearly the same job at one-fifth the cost.

> **Sundaram in one line:** "good book, good house, bad price" — the mirror-image of Mahindra (record-and-institution strong, price-and-bench weak). The deepest, most credible record of the seven (20.3 years, the only real 2008 GFC test at −68.7%, a clean 2018 winter, a genuine +8.5% worst-rolling-10Y floor), the safest live risk profile (lowest vol 15.7%, at its ATH, 8-month recovery — real fully-invested defensiveness, not Mahindra's cash artifact or HSBC's mirage), a genuinely active book (55.2% AS) with a working +1.66%/yr gross stock-selection alpha, and the most stable institution of the group (AAA Sundaram Finance parent, no regulatory scar) — but the wrapper confiscates ~90% of the book's alpha (the study's most expensive fee 1.06% + a 0.63% cash drag = +0.17%/yr net, worst fee-for-alpha 0.20×), it has the lowest 10Y CAGR of the seven, runs its mandate 1.8 pts above the SEBI floor, and its forward engine rests on one retained author (Bharath S, 5.4y, the longest lead tenure studied) beside a rookie co-manager with zero prior record on 12 funds. See [funds/sundaram/README.md](funds/sundaram/README.md).
