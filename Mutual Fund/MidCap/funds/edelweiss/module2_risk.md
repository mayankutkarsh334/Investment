...
```mermaid
xychart-beta
    title "Sharpe by window — Edelweiss (stable) vs HSBC (collapse)"
    x-axis ["3Y", "5Y", "5Y fresh"]
    y-axis "Sharpe" 0 --> 1.2
    bar [1.000, 0.871, 0.801]
    line [1.083, 0.825, 0.740]
```
...
```mermaid
xychart-beta
    title "Edelweiss Mid Cap — annualized volatility by calendar year (%)"
    x-axis [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026]
    y-axis "Volatility %" 0 --> 38
    bar [21.4, 11.3, 20.0, 8.8, 17.7, 14.5, 35.9, 12.9, 16.6, 11.5, 12.2, 18.9, 21.3]
```
